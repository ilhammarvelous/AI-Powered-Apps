...
import { BadgeDollarSignIcon, BanknoteIcon, LayoutDashboardIcon } from "lucide-react";
import { cn } from "cn";
...
export function AppSidebar(){
    ...
    return(
        <Sidebar collapsible="icon" variant="floating">
            <SidebarHeader className="gap-2 flew-row items-center">
                <SidebarMenu>
                    <SidebarMenuItem>
                        <SidebarMenuButton asChild>
                            <Link href="/dashboard">
                                <BadgeDollarSignIcon className="text-primary size-5!" />
